...
fn test_pattern_fits_canonical() {
    ...
    assert_eq!(mj.pattern_fits(0, 0, &pattern_mirror_180), Some(-3));
    // assert_eq!(
    ...
    assert_eq!(mj.pattern_fits(0, 0, &pattern_mirror_270), Some(-4));
    // assert_eq!(
